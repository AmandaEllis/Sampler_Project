...
source("new_X_create.R")                       #Source function to create new X from current X
source("new_X_delete.R")                       #Source function to delete X from current X 
source("new_X_reallocate.R")                   #Source function to reallocate photos from current X
source("prop_den_new.R")                       #Source function to calcuate proposal density
source("prop_den_delete.R")                    #Source function to calcuate proposal density
...
#ptm <- proc.time()
#options(warn=2)
check<-rep(NA,length=iterations+burn.in)
check[1]<-0
